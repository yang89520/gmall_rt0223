...
import com.yiran.gmall.realtime.bean.SkuInfo
import com.yiran.gmall.realtime.util.{MyKafkaUtil, OffsetManagerUtil, PhoenixUtil}
...
object SkuInfoApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val topic = Constansts.ODS_SKU_INFO
    val groupId = Constansts.DIM_SKU_INFO_GROUP
