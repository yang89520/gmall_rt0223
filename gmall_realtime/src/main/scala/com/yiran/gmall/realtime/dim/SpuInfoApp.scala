...
import com.yiran.gmall.realtime.bean.SpuInfo
...
object SpuInfoApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val topic = Constansts.ODS_SPU_INFO
    val groupId = Constansts.DIM_SPU_INFO_GROUP
    ...
    objectDstream.foreachRDD{rdd=>
      rdd.saveToPhoenix("GMALL0223_SPU_INFO",Seq("ID", "SPU_NAME"  )
